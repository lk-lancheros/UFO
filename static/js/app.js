...
if(inputValue1 ==='') {
  ...
  filteredData1 = tableData.filter(table => table.datetime == inputValue1);
}
...
console.log(filteredData1);
  ...
  filteredData2 = tableData.filter(table => table.city == inputValue2);
}
...
if(inputValue3==='') {
  ...
  filteredData3 = tableData.filter(table => table.state == inputValue3);
}
...
if(inputValue4==='') {
  ...
  filteredData4 = tableData.filter(table => table.country == inputValue4);
}
...
if(inputValue5==='') {
  ...
  filteredData5 = tableData.filter(table => table.shape == inputValue5);
}
